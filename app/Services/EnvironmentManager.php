    ...
    public function getCategorizedSettings(): array
    {
        ...
        return [
            ...
            'mail' => [
                ...
                'MAIL_FROM_ADDRESS' => $vars['MAIL_FROM_ADDRESS'] ?? 'contact@vennamraj.com',
                'MAIL_FROM_NAME' => $vars['MAIL_FROM_NAME'] ?? 'Vennamraj Associates',
            ],
            'app' => [
                'APP_NAME' => $vars['APP_NAME'] ?? 'Vennamraj Associates',
                'APP_ENV' => $vars['APP_ENV'] ?? 'local',
                'APP_DEBUG' => $vars['APP_DEBUG'] ?? 'true',
                'APP_URL' => $vars['APP_URL'] ?? 'http://localhost:8000',
                'LEGAL_APP_NAME' => $vars['LEGAL_APP_NAME'] ?? 'Vennamraj Associates',
