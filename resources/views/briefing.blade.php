    ...
    <div class="max-w-5xl mx-auto pb-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 divide-y md:divide-y-0 md:divide-x divide-[#EFECE6]">
            ...
            <div class="px-0 md:px-4 flex flex-col gap-4 pt-4 md:pt-0">
                <span class="font-mono text-[11px] font-bold uppercase tracking-wider text-[#9F8349] border-b border-[#E8DAC8] pb-1">Chambers Docket &amp; Hearings</span>
                
                @foreach($events as $ev)
                <div class="p-3 rounded bg-white border border-[#EFECE6] flex flex-col gap-1">
                    <div class="flex items-center justify-between">
                        <span class="font-mono text-xs font-bold text-[#9F8349]">{{ $ev->start_time->format('g:i A') }}</span>
                ...
                <div class="p-4 bg-[#F8F4EE] border border-[#F4ECE1] rounded-lg mt-2">
                    <span class="font-mono text-[10px] font-bold uppercase text-[#856C36]">Judicial Intelligence</span>
                    <p class="text-xs text-[#9F8349] mt-1 leading-relaxed">
            ...
            <div class="pl-0 md:pl-4 flex flex-col gap-4 pt-4 md:pt-0">
                <span class="font-mono text-[11px] font-bold uppercase tracking-wider text-[#9F8349] border-b border-[#ffe08f] pb-1">Financials &amp; Action Matrix</span>
                ...
                <div class="flex flex-col gap-2 mt-2">
                    ...
                    <div class="text-xs p-2 rounded bg-[#FAF8F5] border border-[#F4EFEA] flex items-start gap-2">
                        <input type="checkbox" class="mt-0.5 rounded text-[#9F8349] accent-[#9F8349]"/>
                        <div>
