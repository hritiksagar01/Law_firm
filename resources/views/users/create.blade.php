...
@section('title', 'Add Team Member — ' . config('legal.app_name', 'Vennamraj Associates'))
...
<div class="max-w-4xl mx-auto p-6 md:p-8">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-serif font-bold text-[#222222]">Add Team Member</h1>
        <p class="text-sm text-[#766A5E] mt-1">Onboard an advocate, legal researcher, paralegal, or chambers staff member</p>
    </div>
    ...
    <form method="POST" action="{{ route('users.store') }}" class="space-y-6">
        ...
        <div class="bg-white p-6 rounded-2xl border border-[#EFECE6] shadow-xs">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="md:col-span-2">
                    <label class="block text-xs font-semibold text-[#222222] mb-1">Temporary Initial Password *</label>
        ...
        <div class="bg-white p-6 rounded-2xl border border-[#EFECE6] shadow-xs">
            ...
            <div class="space-y-4">
                <div>
                    <label class="block text-xs font-semibold text-[#222222] mb-1">Select Practice Role *</label>
                ...
                <div class="pt-4 border-t border-[#EFECE6]">
                    <label class="block text-xs font-semibold text-[#222222] mb-1">Assign Practice Groups</label>
                    <p class="text-[11px] text-[#766A5E] mb-2">Member will collaborate with other advocates in selected groups</p>
