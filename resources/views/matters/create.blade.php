<x-app-layout>
    ...
    <div class="max-w-3xl mx-auto pb-12">
        <div class="mb-6 flex items-center justify-between">
            <div>
                <a href="{{ route('matters.index') }}" class="inline-flex items-center gap-1 text-xs text-[#766A5E] hover:text-[#845D33] mb-2">
        ...
        <form action="{{ route('matters.store') }}" method="POST" class="bg-white rounded-xl border border-[#EFECE6] shadow-sm p-6 flex flex-col gap-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="flex flex-col gap-1">
                    ...
                    <select name="client_id" required class="w-full h-10 px-3 rounded-lg bg-[#FAF8F5] border border-[#EAE4DC] text-sm text-[#222222] focus:outline-none focus:border-[#845D33] focus:bg-white">
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <select name="practice_area" required class="w-full h-10 px-3 rounded-lg bg-[#FAF8F5] border border-[#EAE4DC] text-sm text-[#222222] focus:outline-none focus:border-[#845D33] focus:bg-white">
            ...
            <div class="flex flex-col gap-1">
                ...
                <input name="title" required placeholder="e.g. Malhotra Enterprises v. Apex Commercial Bank" class="w-full h-10 px-3 rounded-lg bg-[#FAF8F5] border border-[#EAE4DC] text-sm text-[#222222] focus:outline-none focus:border-[#845D33] focus:bg-white"/>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="flex flex-col gap-1">
                    ...
                    <input name="court_name" placeholder="e.g. High Court of Delhi, New Delhi" class="w-full h-10 px-3 rounded-lg bg-[#FAF8F5] border border-[#EAE4DC] text-sm text-[#222222] focus:outline-none focus:border-[#845D33] focus:bg-white"/>
                </div>
                <div class="flex flex-col gap-1">
                    <label class="text-xs font-semibold text-[#554D45] uppercase tracking-wider">Presiding Judge / Bench</label>
                    <input name="judge_name" placeholder="e.g. Hon. Justice C. Hari Shankar" class="w-full h-10 px-3 rounded-lg bg-[#FAF8F5] border border-[#EAE4DC] text-sm text-[#222222] focus:outline-none focus:border-[#845D33] focus:bg-white"/>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="flex flex-col gap-1">
                    ...
                    <select name="lead_attorney_id" required class="w-full h-10 px-3 rounded-lg bg-[#FAF8F5] border border-[#EAE4DC] text-sm text-[#222222] focus:outline-none focus:border-[#845D33] focus:bg-white">
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <select name="stage" class="w-full h-10 px-3 rounded-lg bg-[#FAF8F5] border border-[#EAE4DC] text-sm text-[#222222] focus:outline-none focus:border-[#845D33] focus:bg-white">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="flex flex-col gap-1">
                    ...
                    <select name="billing_type" class="w-full h-10 px-3 rounded-lg bg-[#FAF8F5] border border-[#EAE4DC] text-sm text-[#222222] focus:outline-none focus:border-[#845D33] focus:bg-white">
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <input name="budget" type="number" step="5000" value="250000" class="w-full h-10 px-3 rounded-lg bg-[#FAF8F5] border border-[#EAE4DC] text-sm font-mono text-[#222222] focus:outline-none focus:border-[#845D33] focus:bg-white"/>
                </div>
            </div>
            ...
            <div class="pt-4 border-t border-[#F4EFEA] flex items-center justify-end gap-3">
                ...
                <button type="submit" class="px-5 py-2 rounded-lg bg-[#845D33] text-white text-xs font-semibold hover:bg-[#6D4B27] shadow-sm transition-colors">
